...
fn container_diagnostics() {
    ...
    let cases = [
        ...
        (
            ...
            "let container = built.unwrap(); container.resolve_clone_i_value(); container.resolve_clone_i_value_in_test(); container.resolve_i_size();",
            None,
        ),
        (
            ...
            "built.unwrap().resolve_clone_i_value();",
            Some("E0599"),
        ),
        (
        ...
        (
            ...
            "",
            Some("interfaces generate the same resolver name: resolve_clone_i_value_in_test"),
        ),
        (
            ...
            "",
            Some("interfaces generate the same resolver name: resolve_clone_i_value_in_default"),
        ),
        (
            "operation_modifier_method_name_collision",
            "",
            "register_value!(String::new(): String as IValue); register_value!(String::new(): String as CloneIValue);",
            "",
            Some("interfaces generate the same resolver name: resolve_clone_i_value"),
        ),
        (
            ...
            "let container = built.unwrap(); container.resolve_clone_i_value(); container.resolve_clone_i_value_ref();",
            None,
        ),
        (
        ...
        (
            ...
            "built.unwrap().resolve_clone_i_value_i_value();",
            None,
        ),
        (
        ...
        (
            ...
            "let container = built.unwrap(); container.resolve_clone_i_value(); container.resolve_i_number(); container.resolve_i_size();",
            None,
        ),
        (
        ...
        (
            ...
            "built.unwrap().try_resolve_clone_i_value();",
            Some("E0599"),
        ),
        (
        ...
        (
            ...
            "let path: std::path::PathBuf = built.unwrap().resolve_clone_i_config_path();",
            None,
        ),
        (
